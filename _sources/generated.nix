...
}:
{
  ...
  curd = {
    pname = "curd";
    version = "224934754b89e6de6260df29dc716311fa0341dd";
    src = fetchFromGitHub {
      owner = "Wraient";
      repo = "curd";
      rev = "224934754b89e6de6260df29dc716311fa0341dd";
      fetchSubmodules = false;
      sha256 = "sha256-0Dv1DzEvYkUzRQQtVSYuF75qssUcFaO/GoOusOnlqlM=";
    };
    date = "2024-10-06";
  };
  dblab = {
  ...
  minimal-tmux-status = {
    ...
    version = "86de1697b6b0522ebd36b5fe83c5fd9b7e30f15f";
    src = fetchFromGitHub {
      owner = "niksingh710";
      repo = "minimal-tmux-status";
      rev = "86de1697b6b0522ebd36b5fe83c5fd9b7e30f15f";
      fetchSubmodules = false;
      sha256 = "sha256-lDPT3XRH14Z5WTdtWhgiYa8FjQHeYFCY7Dpy9xU8vyM=";
    };
    date = "2024-07-16";
  };
  miru = {
