...
}:
{
  ...
  pnut = {
    pname = "pnut";
    version = "2fca563fd871199bf4570ec880d4f4812c69cbca";
    src = fetchFromGitHub {
      owner = "udem-dlteam";
      repo = "pnut";
      rev = "2fca563fd871199bf4570ec880d4f4812c69cbca";
      fetchSubmodules = false;
      sha256 = "sha256-UZZXUdaE+rUNauNmH4Vwx1ugLG9ofKynXWKfu2wstD0=";
    };
    date = "2025-03-12";
  };
  posting = {
  ...
  tach = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.28.1";
      fetchSubmodules = false;
      sha256 = "sha256-XeirlRtqQya31BSnsHN+Sff+GQ7Bb29CcD5+7WtqKFs=";
    };
  };
  task-relative-recur = {
  ...
  tmux-pane-focus = {
    ...
    version = "c5efe272bac7a368432f988405aabca31ce3cae4";
    src = fetchFromGitHub {
      owner = "graemedavidson";
      repo = "tmux-pane-focus";
      rev = "c5efe272bac7a368432f988405aabca31ce3cae4";
      fetchSubmodules = false;
      sha256 = "sha256-R3DQvfvQ+JwZmF2qeVsEFPlbEZDiqPeh6JDVzbDSHcs=";
    };
    date = "2025-02-28";
  };
  tmux-power-zoom = {
