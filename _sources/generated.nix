...
}:
{
  ...
  docker-flaresolverr = {
    ...
    src = dockerTools.pullImage {
      ...
      sha256 = "sha256-ATtC9R0HCPj7y4tIXJD+MXQbAnKj+iONp2gdi3SNaEc=";
      finalImageTag = "v3.4.5";
    };
  };
  docker-freshrss = {
  ...
  docker-kavita = {
    ...
    src = dockerTools.pullImage {
      ...
      imageDigest = "sha256:73edf1a4380700f3d4192c7a1f136f4a0fbefd0a4df31db7a0b35f1e1819268a";
      sha256 = "sha256-piPw+ZJxuaW4zMZjuSYp5H/Uuh7SK1Vujyz1XfixMAI=";
      finalImageTag = "0.8.8";
    };
  };
  docker-lancommander = {
  ...
  docker-siyuan = {
    ...
    src = dockerTools.pullImage {
      ...
      imageDigest = "sha256:d63485de0b47af96aa7b9fc2dc9d53cb682f114510b2b0e8068f8ea11bfd4579";
      sha256 = "sha256-Q4QiygNpCReL7DySAOe0efqezNa4adHFE1xAHqGUV/U=";
  ...
  dps-ghosttext-vim = {
    ...
    version = "b13b8325f34ad98f37818829fece8ddb8a43f859";
    src = fetchFromGitHub {
      owner = "gamoutatsumi";
      repo = "dps-ghosttext.vim";
      rev = "b13b8325f34ad98f37818829fece8ddb8a43f859";
      fetchSubmodules = false;
      sha256 = "sha256-ayDxBGbf9KsBve8gc9nXPy8DOcSpoAhHLf+W8p5yCro=";
    };
    date = "2025-11-18";
  };
  dra = {
  ...
  musicdl = {
    pname = "musicdl";
    version = "69720a5ca88a8224746b637af87ecfe825df2ff6";
    src = fetchFromGitHub {
      owner = "CharlesPikachu";
      repo = "musicdl";
      rev = "69720a5ca88a8224746b637af87ecfe825df2ff6";
      fetchSubmodules = false;
      sha256 = "sha256-gJNUzdX0QD2aLAJafW1aktHN9mm0mN12hD057S9gGK8=";
    };
    date = "2025-11-19";
  };
  natmap = {
  ...
  numara = {
    ...
    version = "6.5.1";
    src = fetchurl {
      url = "https://github.com/bornova/numara-calculator/releases/download/v6.5.1/Numara-6.5.1-x86_64.AppImage";
      sha256 = "sha256-Eq/jaBhh067QqcCBtrAq9w+EcXNbHKN55n4ZL1by23M=";
    };
  };
  org-export = {
    pname = "org-export";
  ...
  qlty = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.589.0";
      fetchSubmodules = false;
      sha256 = "sha256-YwzxowG9OYXbzpraWyAmx61UHK+LUfSEYfhzrLWvGbE=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-YwzxowG9OYXbzpraWyAmx61UHK+LUfSEYfhzrLWvGbE=/Cargo.lock";
      outputHashes = {
  ...
  sonicradio = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.8.9";
      fetchSubmodules = false;
      sha256 = "sha256-pAYmrDtpVOb4zPXNk+glEDJYwJs8VqfP2k/9G/rALmY=";
    };
  };
  soundfx = {
    pname = "soundfx";
  ...
  tach = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.32.0";
      fetchSubmodules = false;
      sha256 = "sha256-RpDGgTrJtMuIp4kBGjiFsGfEvyDiafBF26JFd6f4urE=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-RpDGgTrJtMuIp4kBGjiFsGfEvyDiafBF26JFd6f4urE=/Cargo.lock";
      outputHashes = {
  ...
  textual = {
    ...
    version = "6.6.0";
    src = fetchurl {
      url = "https://pypi.org/packages/source/t/textual/textual-6.6.0.tar.gz";
      sha256 = "sha256-UzRRZtaw+f0CjtAhfXO49Hw6JmeaGLo7Z2FtystHDuw=";
    };
  };
  timewarrior = {
    pname = "timewarrior";
  ...
  zashboard = {
    ...
    version = "v2.2.0";
    src = fetchurl {
      url = "https://github.com/Zephyruso/zashboard/releases/download/v2.2.0/dist.zip";
      sha256 = "sha256-sahH82IaP7VTvHD7pLjcEwoMwwzq7N17RTtWGBezZAE=";
    };
  };
  zhlint = {
    pname = "zhlint";
