...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  comigo = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.0.0";
      fetchSubmodules = false;
      sha256 = "sha256-foFN/ppXJsR72qshX83flBFr9/gElQ4dw+hF9pRhDVQ=";
    };
  };
  complate = {
    pname = "complate";
  ...
  dela = {
    pname = "dela";
    version = "b2178bbac159806e20f6ac324b648e4a8504c430";
    src = fetchFromGitHub {
      owner = "aleyan";
      repo = "dela";
      rev = "b2178bbac159806e20f6ac324b648e4a8504c430";
      fetchSubmodules = false;
      sha256 = "sha256-46FV2noMN7Drh/mkrFgojPGHeGwkY/9Wr+cyu1v6Ye0=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./dela-b2178bbac159806e20f6ac324b648e4a8504c430/Cargo.lock;
      outputHashes = {
  ...
  mpv-smartcopypaste_ii = {
    ...
    version = "4701419f9b9063a5425f3942ec62cc029599430d";
    src = fetchFromGitHub {
      owner = "Eisa01";
      repo = "mpv-scripts";
      rev = "4701419f9b9063a5425f3942ec62cc029599430d";
      fetchSubmodules = false;
      sha256 = "sha256-P4leX7FTg39JhcfE9bOqVxH4UIyF7f3HNe+9a7a+POs=";
    };
    date = "2025-05-08";
  };
  mpv-smartskip = {
  ...
  simple-completion-language-server = {
    ...
    version = "ff33d965e28004800ace2449a73f7dc74cdbe815";
    src = fetchFromGitHub {
      owner = "estin";
      repo = "simple-completion-language-server";
      rev = "ff33d965e28004800ace2449a73f7dc74cdbe815";
      fetchSubmodules = false;
      sha256 = "sha256-jb4VEHJCCqYVS4llXJoyZpAy9OdwVD8isChhYe0Jr4I=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./simple-completion-language-server-ff33d965e28004800ace2449a73f7dc74cdbe815/Cargo.lock;
      outputHashes = {
  ...
  v2ray-rules-dat-geoip = {
    ...
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202505072214/geoip.dat";
  ...
  v2ray-rules-dat-geosite = {
    ...
    version = "202505072214";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202505072214/geosite.dat";
  ...
  vim-floaterm = {
    pname = "vim-floaterm";
    version = "204a01a3868cbe4549640dca857fb3880ee92b17";
    src = fetchFromGitHub {
      owner = "voldikss";
      repo = "vim-floaterm";
      rev = "204a01a3868cbe4549640dca857fb3880ee92b17";
      fetchSubmodules = false;
      sha256 = "sha256-/RNUIHaMJHks0/upletAamojDTZGNq45dZ2QCPvqfzs=";
    };
    date = "2025-04-28";
  };
  vim-ghost = {
  ...
  zashboard = {
    ...
    version = "v1.82.0";
    src = fetchurl {
      url = "https://github.com/Zephyruso/zashboard/releases/download/v1.82.0/dist.zip";
      sha256 = "sha256-SRL3/6y6XiPxqiiN2/fznzqFU7SduyXomUgEcyEkkdM=";
    };
  };
}
