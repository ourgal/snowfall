...
}:
{
  ...
  comigo = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.1.4";
      fetchSubmodules = false;
      sha256 = "sha256-S60MtdCSaAF5PUyGGTnxWEr2ktuBaASlzt7YXTLQkpg=";
    };
  };
  complate = {
    pname = "complate";
  ...
  docker-pairdrop = {
    ...
    src = dockerTools.pullImage {
      ...
      imageDigest = "sha256:cb06203233c551f6c77f342dd30e2b7d48faac32bc880ed9392aa7f2949d18ad";
      sha256 = "sha256-PPSA7QT567O68RNlFqKxq7pic0aGeHdoCeUTx6ETY5A=";
  ...
  docker-siyuan = {
    ...
    src = dockerTools.pullImage {
      ...
      imageDigest = "sha256:2bf66a37f37cec5c8641905da7371fa0faf077d1cc5cae92844d1170c7598837";
      sha256 = "sha256-rC3noG8bIQxxhRvkdDVyPE/CgbE4iD74mTPRNAtALuU=";
  ...
  dps-ghosttext-vim = {
    ...
    version = "1c77623b1ffb926c1739ec71b5764d521985970c";
    src = fetchFromGitHub {
      owner = "gamoutatsumi";
      repo = "dps-ghosttext.vim";
      rev = "1c77623b1ffb926c1739ec71b5764d521985970c";
      fetchSubmodules = false;
      sha256 = "sha256-7IaVpvGKCFrvSdi6EVNpaiZv5VtGZW268QFiqxXh9S8=";
    };
    date = "2025-11-20";
  };
  dra = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.9.1";
      fetchSubmodules = false;
      sha256 = "sha256-jL/3AqXdlXW3Nut1VMol1WqME2CEpCtF2Tel6fxwdqs=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-jL_3AqXdlXW3Nut1VMol1WqME2CEpCtF2Tel6fxwdqs=/Cargo.lock";
      outputHashes = {
  ...
  hayase = {
    ...
    version = "6.4.38";
    src = fetchurl {
      url = "https://github.com/hayase-app/docs/releases/download/v6.4.38/linux-hayase-6.4.38-linux.AppImage";
      sha256 = "sha256-Pu8Orfeiwd9QJFHgIa119WR/45cND64asz9KjU11W+k=";
    };
  };
  hl = {
    pname = "hl";
  ...
  hledger-fmt = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.3.7";
      fetchSubmodules = false;
      sha256 = "sha256-u3J5wBEbxEBSr54+WxR0zkR2MGsjhkaebCMOh8+jOZk=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-u3J5wBEbxEBSr54+WxR0zkR2MGsjhkaebCMOh8+jOZk=/Cargo.lock";
      outputHashes = {
  ...
  musicdl = {
    pname = "musicdl";
    version = "b7ea13fa41c31ce89464eba5ad04e129ed5beddb";
    src = fetchFromGitHub {
      owner = "CharlesPikachu";
      repo = "musicdl";
      rev = "b7ea13fa41c31ce89464eba5ad04e129ed5beddb";
      fetchSubmodules = false;
      sha256 = "sha256-uAD+7AfvEmHQrKgv5AvirAuhCUiuB/HclTkkk2oHqCo=";
    };
    date = "2025-12-01";
  };
  natmap = {
  ...
  numara = {
    ...
    version = "6.5.2";
    src = fetchurl {
      url = "https://github.com/bornova/numara-calculator/releases/download/v6.5.2/Numara-6.5.2-x86_64.AppImage";
  ...
  pyfreeproxy = {
    ...
    version = "0.2.2";
    src = fetchurl {
      url = "https://pypi.org/packages/source/p/pyfreeproxy/pyfreeproxy-0.2.2.tar.gz";
      sha256 = "sha256-jnEIMtTnqtyGslsBgCUHi5Do4QjppZ/5jYQJjX8KD1Y=";
    };
  };
  pyjokes = {
    pname = "pyjokes";
  ...
  quartz = {
    pname = "quartz";
    version = "a7583558d306754451502ca8794bd2c43405e04a";
    src = fetchFromGitHub {
      owner = "vimpostor";
      repo = "quartz";
      rev = "a7583558d306754451502ca8794bd2c43405e04a";
      fetchSubmodules = false;
      sha256 = "sha256-vVBo5qWHB1UfBzJFN2fdowfIlvr89jfDVmOSDOwGCRo=";
    };
    date = "2025-11-15";
  };
  quickbench = {
  ...
  shh = {
    pname = "shh";
    version = "55da9fe44be866c992b37089b1475294421b89ca";
    src = fetchFromGitHub {
      owner = "desbma";
      repo = "shh";
      rev = "55da9fe44be866c992b37089b1475294421b89ca";
      fetchSubmodules = false;
      sha256 = "sha256-1XDg60Xi30JazlaPgWyeytkMtu4+D9Adp5+vTCnGBEM=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-1XDg60Xi30JazlaPgWyeytkMtu4+D9Adp5+vTCnGBEM=/Cargo.lock";
      outputHashes = {
  ...
  simplemoji = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.2.2";
      fetchSubmodules = false;
      sha256 = "sha256-28jn78HQksb0lr8rtOtNF7O4AbbrQnCmLgJwqI/UKzc=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-28jn78HQksb0lr8rtOtNF7O4AbbrQnCmLgJwqI_UKzc=/Cargo.lock";
      outputHashes = {
  ...
  soba = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.4.1";
      fetchSubmodules = false;
      sha256 = "sha256-4SnnWYwdkZT2lJdXQQLJC+popGtMIyLci3mtBc+BgF0=";
    };
  };
  sonicradio = {
    pname = "sonicradio";
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.8.11";
      fetchSubmodules = false;
      sha256 = "sha256-2p/QgE6nCHvkpUwNCCH6PWrR35vkJKdtxlmpQALhgPI=";
    };
  };
  soundfx = {
    pname = "soundfx";
  ...
  tach = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.32.1";
      fetchSubmodules = false;
      sha256 = "sha256-I7b5BJxCINmWxVnip3gWZSbQrmxhrcEYx5NTrbeUeDE=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-I7b5BJxCINmWxVnip3gWZSbQrmxhrcEYx5NTrbeUeDE=/Cargo.lock";
      outputHashes = {
  ...
  textual = {
    ...
    version = "6.7.0";
    src = fetchurl {
      url = "https://pypi.org/packages/source/t/textual/textual-6.7.0.tar.gz";
      sha256 = "sha256-7x/Vh6O1spd31LAwN+Co8Q0XTmM2bpml2FGKdLU4Ljg=";
    };
  };
  timewarrior = {
    pname = "timewarrior";
  ...
  zashboard = {
    ...
    version = "v2.3.0";
    src = fetchurl {
      url = "https://github.com/Zephyruso/zashboard/releases/download/v2.3.0/dist.zip";
      sha256 = "sha256-T1yFKWIento7T9ZznO2LngQw/3dqvdoep+qH8dVaWuI=";
    };
  };
  zhlint = {
    pname = "zhlint";
