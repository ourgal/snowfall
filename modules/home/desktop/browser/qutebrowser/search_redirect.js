...
!(function () {
  ...
  debug("程序开始");
  if (
    (inExtMode === true && inGMMode === true) ||
    typeof window.AC666Init !== "undefined"
  ) {
  ...
  (function () {
    ...
    let DefaultConfig = {
      ...
      defaultFaviconUrl:
        "https://ae01.alicdn.com/kf/HTB1dRY0X8OD3KVjSZFFq6An9pXay.jpg", // 默认图标地址
  ...
  .yg51vc {
    ...
    let DBSite = {
      baidu: {
        ...
        FaviconAddTo: "h3",
        CounterType:
          "#content_left>#double>div[srcid] *[class~=t]>a:first-child,[class~=op_best_answer_question],#content_left>div[srcid] *[class~=t]>a:first-child,[class~=op_best_answer_question]",
        BlockType: "h3 a",
        pager: {
          ...
          replaceE: "css;#page",
          stylish:
            ".autopagerize_page_info, div.sp-separator {margin-bottom: 10px !important;}.c-img-border{display:none}",
        },
      },
      sogou: {
        SiteTypeID: 2,
      ...
      google: {
        ...
        pager: {
          ...
          pageElement:
            "id('rso')|id('center_col')/style[contains(.,'relative')][id('rso')]",
          HT_insert: ["css;#res", 2], // 1 = beforebegin; 2 = beforeend
          replaceE:
            '//div[@id="navcnt"] | //div[@id="rcnt"]//div[@role="navigation"]',
        },
      },
      google_scholar: {
        SiteTypeID: 4.1,
      ...
      bing: {
        ...
        FaviconAddTo: "h2",
        CounterType:
          "#b_results>li[class~=b_ans] h2,#b_results>li[class~=b_algo] h2",
        BlockType: "h2 a",
        Stype_Normal: "h2>a",
        pager: {
      ...
      mBaidu: {
        ...
        FaviconAddTo: "h2",
        CounterType:
          "#b_results>li[class~=b_ans]>h2,#b_results>li[class~=b_algo]>h2,#b_results>li[class~=b_algo]>h2",
        BlockType: "h2 a",
      },
      zhihu: {
        SiteTypeID: 7,
      ...
      baidu_xueshu: {
        ...
        FaviconAddTo: "h3",
        CounterType:
          "#content_left>#double>div[srcid] *[class~=t]>a,[class~=op_best_answer_question],#content_left>div[srcid] *[class~=t]>a,[class~=op_best_answer_question]",
        BlockType: "h3 a",
      },
      other: {
        SiteTypeID: 9,
        ...
        zh_cn: {
          ...
          fieldset_panel: {
            ...
            setting_panel: {
              ...
              blockenable_title:
                "点击页面block按钮添加你想要隐藏的地址，脚本将自动隐藏部分结果为小横幅，DIY按钮中点击表格内容可以取消隐藏",
        ...
        en: {
          ...
          fieldset_panel: {
            ...
            setting_panel: {
              ...
              ads_title:
                "Remove the ads on the page, and return you a clean page",
              autopage_text: "Auto Pager",
              autopage_title: "Auto Pager",
              blockenable_text: "Add2-Block host",
              blockenable_title:
                "Click the Block button to add the address which you want to hide. The script will hide it with small banner automatically. DIY button for editting the hiding list",
              blockDiyBtn_text: "DIY",
              ...
              backgroundImageAutoFit_text_hint:
                "page auto fit when Bg is not null",
              ...
              searchOrigin_title:
                "Add6-Remove Baidu AutoPredict in text search",
              ...
              contactMe_text:
                "For contact the writter, suggests, ask for help then click me",
              contactMe_url: "https://github.com/langren1353/GM_script/",

              setting_panel_second: {
                backBtn_text: "<-Back",
                blockLabel_text:
                  "&nbsp;Block List&nbsp;&nbsp;Click Save Button if you want wo save the list",
    ...
    let vueVM = null;
    /**初始化所有的设置**/
    Promise.all([GM.getValue("Config")])
      .then(function (data) {
        let res = data[0];
        ...
        if (
          ACConfig.isUserStyleEnable === false &&
          new Date().getTime() - ACConfig.lastSaveTime > 2592000000
        ) {
          // 大约30天时间
        ...
        AllData.lan.use = ACConfig.isEnLang
          ? AllData.lan.en
          : AllData.lan.zh_cn;
        // 初始化完成之后才能调用正常函数
        callback();
    ...
    function callback() {
      ...
      !(async function () {
        if (typeof GM_getResourceText === "undefined") {
          GM.getResourceText = GM_getResourceText = async function (
            aResourceName,
          ) {
            let res = await (
              await fetch(await GM.getResourceUrl(aResourceName))
            ).text();
        ...
        if (location.host.includes("xueshu.baidu.com")) {
          ...
          if (
            navigator.userAgent.replace(/(android|mobile|iphone)/gim, "") !==
            navigator.userAgent
          ) {
        ...
        curSite.GMStyleList = {};
        if (
          (curSite.SiteTypeID === SiteType.GOOGLE &&
            location.href.replace(/tbm=(isch|lcl|shop|flm)/, "") !==
              location.href) ||
          (curSite.SiteTypeID === SiteType.BING &&
            location.href.replace(/images\/search/, "") !== location.href)
        ) {
          // 图片站 、地图站、购物站
        ...
        if (+CONST.useItem.AdsStyleMode > 0) {
          // 非原始模式，那么可以加载图片
        ...
        console.log(
          "%c[AC-Redirect] %cLet Me Introduce you a Very Good Search Engine：%c %s %cSearch Engine.",
          "font-weight:bold;color:cornflowerblue",
          "color:0",
          "font-weight:bold;color:darkorange",
          CONST.useItem.name.replace(
            CONST.useItem.name[0],
            CONST.useItem.name[0].toUpperCase(),
          ),
        ...
        let SiteBlock = {
           ...
           */
          init: function () {
            const needCheckClass = (curSite.MainType + ",")
              .split(",")
              .join(":not([bhandle]),");
            let checkNodes = document.querySelectorAll(
              needCheckClass.substring(0, needCheckClass.length - 1),
            );
              ...
              try {
                ...
                if (faNode) {
                  ...
                  if (!faNode.hasAttribute("hasInsert")) {
                    faNode.parentNode.insertAdjacentHTML(
                      "beforeend",
                ...
                console.error(e);
                const failed_count = +(
                  curNode.getAttribute("failed_count") || 1
                );
          ...
          renderDisplay: throttle(function () {
            ...
            let { md5: md5_tag = "", list: regList = [] } =
              (vueVM && vueVM.calc_block_data) || {}; // 使用Vue的computed属性计算的数据值，一般根本不更新
            let flag = "ac-needhide";
            for (let i = 0; i < checkNodes.length; i++) {
              try {
                let curNode = checkNodes[i];
                let { curHost = "", curUrl = "" } = getNodeHost(
                  curNode.querySelector(curSite.FaviconType),
                );
                if (!curHost) continue;
                ...
                // 减少数据计算
                if (curNode.dataset.md5 && curNode.dataset.md5 === md5_tag)
                  continue;
                if (
                  curUrl &&
                  regList.findIndex((one) => {
                    try {
                  ...
                  if (!curNode.hasAttribute(flag)) {
                    ...
                    (function (xcur) {
                      ...
                      xcur
                        .querySelector(".blockShow")
                        .addEventListener("click", function (env) {
                          this.parentNode
                            .querySelector("button.ghhider")
                            .setAttribute("ac-user-alter", "1"); // 这个属性用于保持在DOM更新时，按钮不变
        ...
        function addStyle(css) {
          ...
          let pi = document.createProcessingInstruction(
            "xml-stylesheet",
            'type="text/css" must="false" href="data:text/css;utf-8,' +
        ...
        if (ACConfig.isFaviconEnable) {
          CONST.flushNode.insert(
            await create_CSS_Node(
              "h3::before, h2::before {content: ' ';display:inline-block}",
              "AC-Style-Favicon",
            ),
          );
        }
        ...
        if (
          curSite.SiteTypeID === SiteType.GOOGLE &&
          ACConfig.isGooleInBaiduModeEnable
        ) {
        ...
        if (curSite.SiteTypeID === SiteType.DUCK) {
          ...
          if (ACConfig.normalizeDuck) {
            setTimeout(function () {
              try {
                DDG.settings.set("kn", 1, {
                  // 新窗口打开页面
                  saveToCloud: true,
                  forceTheme: true,
                });
                DDG.settings.set("kav", 1, {
                  // 连续显示搜索结果
                  saveToCloud: true,
                  forceTheme: true,
                });
        ...
        try {
          if (curSite.SiteTypeID !== SiteType.OTHERS) {
            ...
            safeWaitFunc("body", () => {
              !document.body.hasAttribute(CONST.useItem.name) &&
                document.body.setAttribute(CONST.useItem.name, "1");
              !document.body.classList.contains(CONST.useItem.name) &&
            ...
            var options = {
              ...
              methods: {
                ...
                async labelShowHideEnv(e) {
                  ...
                  CONST.flushNode.insert(
                    await create_CSS_Node(
                      ".XX>label,.XX>br{display:unset !important;}.XX>.label_hide{display:none !important;}".replace(
                        /XX/gm,
                        className,
                      ),
                      "AC-ShowHideItem-" + className,
                    ),
                    "body",
                  );
                  e.stopPropagation();
                ...
                syncToBlockList(env) {
                  this.ACConfig.UserBlockList = env.target.value
                    .split("\n")
                    .filter((item) => item !== "");
                },
                ...
                loadCustomStyle() {
                  less.render(ACConfig.UserStyleText, async (e, css) => {
                    if (e) {
                      ...
                      css = css.css || "";
                      CONST.flushNode.insert(
                        await create_CSS_Node(css, "AC-userStyle", "less"),
                        "head",
                        {
                          isReload: true,
                        },
                ...
                changeResetText() {
                  this.lan.zh_cn.fieldset_panel.setting_panel.resetBtn_text =
                    "双击重置";
                ...
                closePanel() {
                  document.querySelector("#sp-ac-content").style.display =
                    "none";
                },
                resetCSS() {
                ...
                useThisHuyanColor(env) {
                  this.ACConfig.defaultHuYanColor =
                    env.target.value || env.target.dataset.value;
              ...
              computed: {
                ...
                async cal_UserBlockListRegex() {
                  ...
                  if (
                    typeof this.other.addBlockItem !== "undefined" &&
                    this.other.addBlockItem !== ""
                  ) {
                    safeFunction(
                      () => {
                        list.push(
                          new RegExp(
                            this.other.addBlockItem.replace("*", ".*"),
                          ),
                        );
                      },
                      () => {
                  ...
                  this.calc_block_data = {
                    md5: await md5WASM(
                      new TextEncoder().encode(list.join("==")),
                    ), // 编码虽然有问题，但是计算md5足够用了
                    list,
                  };
              ...
              watch: {
                "other.faviconListMap": {
                  ...
                  async handler(val) {
                    ...
                    CONST.flushNode.insert(
                      await create_CSS_Node(css, "AC-faviconTStyle"),
                      "head",
                      {
                        isReload: true,
                      },
        ...
        function MainCallback(e) {
          if (
            ...
            e.target.className.toUpperCase().indexOf("AC-") === 0
          ) {
            return;
        ...
        function ac_spfunc(e) {
                ...
                return 0 == e
                  ...
                  : 1 == (e /= n)
                    ...
                    : (o || (o = 0.3 * n),
                      !a || a < Math.abs(r)
                        ? ((a = r), (i = o / 4))
                        : (i = (o / (2 * Math.PI)) * Math.asin(r / a)),
                      -a *
                        Math.pow(2, 10 * (e -= 1)) *
                        Math.sin(((e * n - i) * (2 * Math.PI)) / o) +
                        t);
                var i;
              },
            ...
            Bounce: {
              ...
              easeInOut: function easeInOut(e, t, r, n) {
                return e < n / 2
                  ...
                  : 0.5 * Tween.Bounce.easeOut(2 * e - n, 0, r, n) +
                      0.5 * r +
                      t;
              },
            },
          ...
          function sp_transition(e, t) {
            ...
            r ||
              ((r =
                (r = Tween[TweenM[prefs.s_method]])[TweenEase[prefs.s_ease]] ||
                r),
          ...
          setTimeout(() => {
            windowscroll(async function (direction, e) {
              if (direction === "down") {
                ...
                if (
                  ACConfig.isAutopage === true &&
                  !(spl && spl.checked === true)
                ) {
                  var scrollTop =
                  ...
                  if (
                    ...
                    if (curSite.SiteTypeID === SiteType.DUCK) {
                      // 可以用已有的方法来实现了
                      if (
                        !ACConfig.normalizeDuck ||
                        +ACConfig.duck.AdsStyleMode >= 3
                      ) {
                        // 如果没有开启，那么手动翻页 || 如果是双列的时候，似乎并不会自动触发翻页效果
                        document
                          .querySelector("#links .result--more a")
                          .click();
                        setTimeout(function () {
                          curSite.pageLoading = false;
                        }, 5000);
        ...
        var ShowPager = {
          getFullHref: function (e) {
            ...
            return (
              t || (this.getFullHref.a = t = document.createElement("a")),
              (t.href = e),
              t.href
            );
          },
          createDocumentByString: function (str) {
            ...
            if (!str) {
              console.error(
                "[AC-Script]",
                "No string found to be converted to DOM",
              );
              return;
            }
            ...
            if (document.implementation.createHTMLDocument) {
              doc =
                document.implementation.createHTMLDocument("superPreloader");
            } else {
              try {
                //@ts-ignore
                doc = document.cloneNode(false);
                doc.appendChild(
                  doc.importNode(document.documentElement, false),
                );
              ...
              GM_xmlhttpRequest({
                ...
                onload: function (response) {
                  try {
                    ...
                    const [Rule_insertTo = "", Rule_insertMode = 1] =
                      curSite.pager.HT_insert || [];
                    let pageElems = getAllElements(
                      curSite.pager.pageElement,
                      newBody,
                      newBody,
                    );
                    const scriptElems = getAllElements(
                      "//script",
                      newBody,
                      newBody,
                    );
                    ...
                    if (pageElems.length) {
                      const curPageElems = getAllElements(
                        curSite.pager.pageElement,
                        document,
                        document,
                      );
                      const pELast = curPageElems[curPageElems.length - 1];
                      toElement = pELast.nextSibling
                        ? pELast.nextSibling
                        : pELast.parentNode.appendChild(
                    ...
                    if (pageElems.length >= 0) {
                      ...
                      insertPager.id = "sp-separator-ACX".replace(
                        /ACX/gm,
                        curSite.pageNum,
                      );
                      ...
                      insertPager.innerHTML = `
                          ...
                          <span id="sp-sp-gobottom" class='ac_sp_bottom' title='去到底部' ></span>`.replace(
                        /ACX/gm,
                        curSite.pageNum,
                      );

                      if (Rule_insertMode === 1) {
                        toElement.parentNode.insertBefore(
                          insertPager,
                          toElement,
                        );
                      ...
                      document
                        .querySelectorAll(".sp-separator.AC:not([bind])")
                      ...
                      try {
                        if (curSite.pager.replaceE) {
                          ...
                          let repE = getAllElements(
                            curSite.pager.replaceE,
                            newBody,
                            newBody,
                          );
          ...
          if (ACConfig.isUserStyleEnable) {
            less.render(ACConfig.UserStyleText, async (e, css) => {
              if (!e) {
                css = css.css || "";
                CONST.flushNode.insert(
                  await create_CSS_Node(css, "AC-userStyle"),
                  "head",
                  {
                    isReload: true,
                  },
...
.aniDelete {
  ...
  opacity: 0.1
          ...
          CONST.flushNode.insert(
            await create_CSS_Node(aniStyle, "AC-AnimationStyle"),
          );
        }
          ...
          try {
            if (curSite.SiteTypeID !== SiteType.OTHERS) {
              try {
                ...
                if (
                  ACConfig.isFaviconEnable &&
                  typeof curSite.FaviconType !== "undefined"
                ) {
                  // 显示favicon图标
                  // 延迟2秒加载，减少可能出现的问题
                  ...
                  document
                    .querySelectorAll(curSite.FaviconType)
                    .forEach((one) => {
                ...
                // }
                if (
                  ACConfig.isBlockEnable &&
                  curSite.SiteTypeID !== SiteType.SOGOU
                ) {
                  // 启用屏蔽功能- 对每一个新增的地址都要处理
                  // 延迟执行，减少页面损耗
                  SiteBlock.init();
                }
                if (document.body) {
                  ...
                  if (
                    ...
                    location.href.includes("tn=news")
                  ) {
                    if (!document.body.hasAttribute("news"))
          ...
          if (curSite.SiteTypeID === SiteType.BAIDU) {
            ...
            if (href != null && !href.includes("baidu.com/link")) {
              ...
              const host = getTextHost(
                sitetpNode.innerText || sitetpNode.textContent,
              );
        ...
        function RedirectHandle() {
          // 处理主重定向
          if (
            curSite.SiteTypeID === SiteType.OTHERS ||
            curSite.SiteTypeID === SiteType.SOGOU
          )
            return;
          if (ACConfig.isRedirectEnable) {
            if (curSite.Stype_Normal) {
              // 如果定义了，那么就去处理重定向
              // 百度搜狗bing去重定向
              resetURLNormal();
              if (checkISBaiduMain()) {
          ...
          try {
            // 放入异常捕获，防止由于html插入过慢导致的js终止
            if (!ACConfig.AdsStyleEnable) {
              document
                .querySelectorAll("input[name*='sp-ac-a_force_style_']")
                .forEach((per) => {
            ...
            if (!ACConfig.isBlockEnable) {
              document
                .querySelectorAll("#sp-ac-removeBlock, #sp-ac-blockBtnDisplay")
                .forEach((per) => {
                  per.setAttribute("disabled", "disabled");
        ...
        function ACtoggleSettingDisplay(e) {
          ...
          setTimeout(function () {
            if (
              ...
              DBConfig.oldVersion = ACConfig.oldVersion =
                GM_info.script.version; // 只需要写出一部分的关键数据即可
              ACSetValue("Config", JSON.stringify(DBConfig));
              document.querySelector(".ac-newversionDisplay").style.display =
                "none";
              document.querySelector("#sp-ac-content").style.display = "block";
            }
          }, 100);
        ...
        function ShowSetting() {
          ...
          if (
            document.body !== null &&
            document.querySelector("#sp-ac-container") === null
          ) {
            let Container = document.createElement("div");
            Container.id = "sp-ac-container";
            Container.innerHTML = `<aside id="sp-ac-content" style="display: none;" xmlns="http://www.w3.org/1999/html">
  <form id="sp-ac-main">
    <fieldset id="sp-ac-autopager-field">
      ...
      <span id="sp-ac-savebutton" ref="bottomSaveButton" @click="saveConfig" class="sp-ac-spanbutton endbutton"
        ...
        v-text="lan.use.fieldset_panel.setting_panel.okBtn_text"></span>
          ...
          try {
            document.querySelector("body #sp-ac-container").addEventListener(
              "click",
              function (e) {
        ...
        function isElementVisible(dom) {
          ...
          return !(
            scrTop > dom.offsetTop + dom.offsetHeight ||
            scrTop + window.innerHeight < dom.offsetTop
          );
        }
          ...
          for (let i = 0; i < nodes.length; i++) {
            ...
            safeFunction(function () {
              ...
              curNode
                ...
                .setAttribute("rl-link-href", trueLink);
        ...
        function resetURLNormal() {
          ...
          for (let i = 0; i < mainList.length; i++) {
            ...
            if (
              curNode !== null &&
              curNode.getAttribute("ac_redirectStatus") === null
            ) {
              ...
              if (
                linkNode.href &&
                (linkNode.href.startsWith("javascript") ||
              ...
              const isLinkNeedDeal = () => {
                ...
                let trueLink =
                  curNode.getAttribute("mu") ||
                  linkNode.getAttribute("data-mdurl");
              ...
              const getBaiduEncodingHandle = (linkUrl) => {
                ...
                if (
                  curSite.SiteTypeID === SiteType.BAIDU &&
                  linkUrl.includes("baidu.com")
                ) {
                  const [, first = ""] =
                    /(ie=[^&]+)/.exec(location.search) || [];
              ...
              // 走接口重定向处理
              if (
                linkHref.includes("www.baidu.com/link") ||
                      ...
                      if (response.responseText || response.responseHeaders) {
                        ...
                        if (response.responseHeaders.includes("tm-finalurl")) {
                          ...
                          if (
                            relURL === null ||
                            relURL === "" ||
                            relURL.includes("www.baidu.com/search/error")
                          )
                            return;
          ...
          if (
            hasDealHrefSet.size > 0 &&
            mainList.length - hasDealHrefSet.size > 0
          )
            console.log(
              "丢弃掉",
              mainList.length - hasDealHrefSet.size,
              "个重复链接",
            );
        }
        ...
        function DealRedirect(
          ...
          if (
            resultResponseUrl !== null &&
            resultResponseUrl !== "" &&
            !resultResponseUrl.includes("www.baidu.com/link")
          ) {
            try {
              if (curSite.SiteTypeID === SiteType.SOGOU)
                curNodeHref = curNodeHref.replace(
                  /^https:\/\/www.sogou.com/,
                  "",
                );
              ...
              document
                .querySelectorAll("*[href*='" + curNodeHref + "']")
                .forEach((per) => {
                  let changeNode = per;
                  ...
                  if (
                    ...
                    if (
                      changeNode.text &&
                      changeNode.text.length < 10 &&
                      !changeNode.text.includes(host) &&
                      // 不能是redirect url 不能是h2\h3下直属链接
                      !changeNode.parentElement.tagName
                        .toLowerCase()
                        .includes("h")
                    ) {
                      changeNode.insertAdjacentHTML(
                        "beforeEnd",
                        "&nbsp;-&nbsp;" + host,
                      );
                    }
        ...
        function removeAD_baidu_sogou() {
          // 移除网站自有广告
          if (
            curSite.SiteTypeID === SiteType.BAIDU ||
            curSite.SiteTypeID === SiteType.MBAIDU
          ) {
            /****移除PC模式上的部分广告****/
            // 移除shadowDOM广告；搜索关键字：淘宝；然后点击搜索框，广告会多次重现shadowdom
            safeFunction(function () {
              $(".c-container >>> .c-container")
                .has('.f13>span:starts-with("广告")')
                .remove();
            });

            // 移除右侧栏广告
            safeRemove_xpath(
              "id('content_right')/div[.//a[starts-with(text(), '广告')]]",
            );
            // 移除标准广告
            safeRemove_xpath(
            ...
            // 移除顶部可能出现的 "为您推荐"
            safeRemove_xpath(
              "id('content_left')//div[contains(@class, '_rs')]",
            );

            /****移除Mobile模式上的部分广告****/
            safeRemove_xpath(
              "id('page-bd')/div[not(contains(@class, 'result'))]",
            );
            ...
            // 移除右侧栏顶部广告
            safeRemove_xpath(
              "id('righttop_box')//li[.//span[contains(text(), '广告')]]",
            );
            ...
            // 移除特殊tag，带url标记的广告类
            const resList = [...document.querySelectorAll("ol>li")].filter(
              (one) => one.querySelector("p"),
            ); // 定位到所有包含p标签的li
            const adList = resList.filter((one) =>
              window
                .getComputedStyle(one.querySelector("p"), "::before")
        ...
        function addCounter(citeList) {
          ...
          for (let i = 0; i < citeList.length; i++) {
            ...
            if (index === null || typeof index === "undefined") {
              ...
              // 数据值不同
              // 数据没有被翻译
              if (+index !== checkValue && !/^\d+$/.test(oriIndex)) {
                // 按需更新
        ...
        function addFavicon(citeList) {
          ...
          if (curSite.SiteTypeID !== SiteType.DOGE) {
            for (let index = 0; index < citeList.length; index++) {
              if (null === citeList[index].getAttribute("ac_faviconStatus")) {
                ...
                for (; II <= 5; II++) {
                  ...
                  if (
                    targetNode != null &&
                    targetNode.querySelector(curSite.FaviconAddTo) != null
                  ) {
                    break;
                  }
                }
                if (
                  targetNode.parentNode.hasAttribute("tpl") &&
                  targetNode.parentNode.getAttribute("tpl").includes("stock")
                ) {
                ...
                if (II <= 5) {
                  ...
                  let host = faviconUrl.replace(
                    /[^.]+\.([^.]+)\.([^.]+)/,
                    "$1.$2",
                  );

                  if (
                    !targetNode.hasAttribute("data-favicon-t") &&
                    host.length >= 3
                  ) {
                    let faviconUrl = curNode.href || host;
                    if (
                      curSite.SiteTypeID === SiteType.BAIDU &&
                      faviconUrl.includes("baidu.com/link")
                    ) {
                      faviconUrl = host;
                    }
            ...
            var checkNodes = document.querySelectorAll(
              "#links_wrapper #links .nrn-react-div",
            );
        ...
        function InsertSettingMenu() {
          if (
            curSite.SiteTypeID !== SiteType.OTHERS &&
            document.querySelector("#myuser") === null
          ) {
            ...
            safeWaitFunc(
              ...
              (parent) => {
                ...
                document
                  .querySelector("#myuser .myuserconfig")
                  .addEventListener(
                    "click",
                    function (e) {
      ...
      async function create_CSS_Node(
        css,
        className = "",
        initType = "text/css",
      ) {
        ...
        return !(
          ...
          !(
            ...
            ((document.querySelector("#kw") &&
              document.querySelector("#kw").getAttribute("value")) ||
              "") !== ""
          )
        );
      }
      ...
      function checkDocmentHasNode(nodeClass) {
        for (let i = 0; i < document.childNodes.length; i++) {
          if (
            document.childNodes[i].data &&
            document.childNodes[i].data.indexOf(nodeClass) > 0
          )
      ...
      async function changeSiteBackground(imageUrl) {
        // 这个图片地址可能为：动态图片返回、静态跨域图片
        ...
        CONST.flushNode.insert(
          await create_CSS_Node(css, "AC-BackGroundImage"),
          "head",
          {
            isReload: true,
          },
      ...
      function FSBaidu() {
        // thanks for code from 浮生@未歇 @page https://greasyfork.org/zh-TW/scripts/31642
        // debug("初始化FSBAIDU");
        ...
        const StyleManger = {
          ...
          loadStyle: async function (
            ...
            if (isLocalDebug) {
              ...
              const style =
                curSite.GMStyleList[styleName] ||
                (await GM_getResourceText(styleName));
              return await this.importStyle(
                style,
                "AC-" + insClassName,
                useNormalCSS,
          ...
          loadHuYanStyle: async function (color) {
            ...
            const style = GM_getResourceText("MainHuYanStyle")
              .replace(/#aaa(a*)/gim, color)
              .replace(/#bbb(b*)/gim, this.Lighter(color, -40))
              .replace(/#ccc(c*)/gim, this.Lighter(color, 45));
            CONST.flushNode.insert(
              await create_CSS_Node(
                style,
                "AC-" + CONST.useItem.name + "HuYanStyle-File",
                "less",
              ),
              "head",
              {
          ...
          loadBgImage: async function () {
            if (
              CONST.useItem.defaultBgUrl &&
              CONST.useItem.defaultBgUrl.trim()
            ) {
              changeSiteBackground(CONST.useItem.defaultBgUrl);
            }
          },
          ...
          loadCommonStyle: async function () {
            const node = await this.loadStyle(
              CONST.useItem.name + "CommonStyle",
              CONST.useItem.name + "CommonStyle",
            );
            this.flushDom.insert(node, "DOM");
          },
          ...
          loadOnePageStyle: async function () {
            const node2 = await create_CSS_Node(
            ...
            const node = await this.loadStyle(
              CONST.useItem.name + "OnePageStyle",
              CONST.useItem.name + "OnePageStyle",
            );
            this.flushDom.insert(node, "DOM");
          },
          ...
          loadTwoPageStyle: async function () {
            const node = await this.loadStyle(
              CONST.useItem.name + "TwoPageStyle",
              CONST.useItem.name + "TwoPageStyle",
            );
            this.flushDom.insert(node, "DOM");
            let cssHead = "";
            ...
            if (curSite.SiteTypeID === SiteType.BING)
              cssHead = "#b_content #b_results";
            if (curSite.SiteTypeID === SiteType.SOGOU)
              cssHead = "#main .results";
            if (curSite.SiteTypeID === SiteType.DUCK)
              cssHead = "#react-layout .react-results--main";
            if (curSite.SiteTypeID === SiteType.DOGE)
              cssHead = "#links_wrapper .results--main #links";
            const node2 = await create_CSS_Node(
              cssHead +
          ...
          findPossibleTwoLines() {
            ...
            function checkOne(element) {
              ...
              if (
                element.hasAttribute("two-checked") ||
                element.id.includes("rhs")
              ) {
                res.skipFind = true;
                return res;
              }
              ...
              const childNodeClassNameList = [...element.children]
                .map((one) => one.className)
                .filter((one) => one && one !== "");
              const childNodeClassNameSet = new Set(childNodeClassNameList);
              const tf =
                childNodeClassNameSet.size !== childNodeClassNameList.length;
              if (tf) {
                // debugger
                res.exist = true;
              }
          ...
          googleFatherChildTag: async function () {
            if (curSite.SiteTypeID === SiteType.GOOGLE) {
              ...
              if (nodeList.length > 0) {
                nodeList.forEach((node) => {
                  const divChildren = [...node.children].filter(
                    (one) => one.tagName.toUpperCase() === "DIV",
                  );
                  const script_styleChildren = [...node.children].filter(
                    (one) => /(SCRIPT|STYLE)/.test(one.tagName.toUpperCase()),
                  );
                  if (
                    divChildren.length >= 2 &&
                    script_styleChildren.length < 3
                  ) {
              ...
              // 特殊元素一行处理
              document
                .querySelectorAll("#rso>div:not(.g)>div[jsmodel]")
                .forEach((one) => {
          ...
          loadCSSToPlain: function () {
            for (let i = 0; i < document.childNodes.length; i++) {
              ...
              // 如果是存在css， 且非必须数据
              if (
                curNode.target === "xml-stylesheet" &&
                curNode.data.indexOf('must="true') < 0
              ) {
                curNode.data = "";
                curNode.del = true;
        ...
        const ControlManager = {
          ...
          centerDisplay: async function () {
            ...
            if (
              acCssLoadFlag === false &&
              document.querySelector(".ACExtension") === null
            ) {
              debug("in样式即将加载:" + result);
              let expandStyle =
                "#wrapper #rs, #wrapper #content_left .result, #wrapper #content_left > .c-container{min-width:670px;}.c-span18{width:78%!important;min-width:550px;}.c-span24{width: auto!important;}";
              if (result === 1) {
                // 单列模式
                this.flushDom.insert(
                  await create_CSS_Node(expandStyle, "AC-Style-expand"),
                );
            ...
            if (
              curSite.SiteTypeID !== SiteType.BAIDU &&
              curSite.SiteTypeID !== SiteType.BAIDU_XUESHU &&
              curSite.SiteTypeID !== SiteType.GOOGLE &&
              curSite.SiteTypeID !== SiteType.BING &&
              curSite.SiteTypeID !== SiteType.SOGOU &&
              curSite.SiteTypeID !== SiteType.DUCK &&
              curSite.SiteTypeID !== SiteType.DOGE
            )
              return;
