...
globalkeys = mytable.join(
  ...
  awful.key({ modkey }, "Return", function()
    awful.spawn("env GLFW_IM_MODULE=ibus " .. terminal)
  ...
  end, { description = "Screen turn off", group = "hotkeys" }),
