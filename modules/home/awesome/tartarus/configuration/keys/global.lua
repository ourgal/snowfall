...
local global_keys = awful.util.table.join(
  ...
  awful.key({ modkey }, "l", function()
    awful.layout.inc(1)
  end, { description = "- select next/prev layout", group = "layout" }),
  ...
  awful.key({ modkey }, "g", function()
    awful.tag.incgap(1)
  end, { description = "inc/dec useless gap", group = "layout" }),
  ...
  awful.key({ "Shift", altkey }, "a", function()
  ...
  end, { description = "view previus/next non-empty tag", group = "tag" }),
  awful.key({ "Shift", altkey }, "d", function(c)
    local focused = awful.screen.focused()
    for i = 1, #focused.tags do
      awful.tag.viewidx(1, focused)
      if #focused.clients > 0 then
  ...
  awful.key({ "Shift", altkey }, "w", function(c)
    awful.screen.focus_relative(1)
  end, { description = "Focus next/previus screen", group = "screen" }),
  awful.key({ "Shift", altkey }, "s", function(c)
    awful.screen.focus_relative(-1)
  end, { description = "Focus next/previus screen", group = "screen" }),
  -- }}}
  ...
  end, { description = "inc/dec volume", group = "hotkeys" }),
  ...
  end, { description = "open default code editor", group = "launcher" }),
