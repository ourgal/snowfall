...
local create_button = function(text, text_color, bg_color, bg_hover, bg_press, signal)
  local textbox = wibox.widget({
    markup = '<span color="' .. text_color .. '" font="Ubuntu Nerd Font Bold 18">' .. text .. "</span>",
...
local sys_monitor = create_button(
  "",
  color.grey,
  color.bg_blackest,
