...
---Cpu----------------------
local text2 = '<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font 16">' .. "  :   " .. "1%" .. "</span>"
...
awful.spawn.easy_async_with_shell(
  [[ df -h --total | tail -n 1 | awk '{print $3 "/" $4}'
]],
  function(out)
    local str = string.gsub(out, "%s+", "")

    storage_usage.markup = icon3
      .. '<span color="'
      .. color.blueish_white
      .. '" font="Ubuntu Nerd Font 16">'
      .. "  :   "
