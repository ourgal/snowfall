...
local country_text = wibox.widget({
  markup = '<span color="' .. color.white .. '" font="Ubuntu Nerd Font 12">' .. "  ,SS" .. "</span>",
  font = "Ubuntu Nerd Font 14",
  widget = wibox.widget.textbox,
  fg = color.white,
  forced_height = dpi(20),
...
local weather_text = wibox.widget({
  markup = '<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font 12">' .. "Loading... " .. "</span>",
  font = "Ubuntu Nerd Font 14",
  widget = wibox.widget.textbox,
  fg = color.white,
  forced_height = dpi(20),
...
local temparature_text = wibox.widget({
  markup = '<span color="' .. color.cyan .. '" font="Ubuntu Nerd Font bold 30">' .. " " .. "°C" .. "</span>",
  font = "Ubuntu Nerd Font 14",
  widget = wibox.widget.textbox,
  align = "center",
  fg = color.white,
...
local humidity_text = wibox.widget({
  markup = '<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font 12">' .. "N/A" .. "</span>",
  font = "Ubuntu Nerd Font 14",
  widget = wibox.widget.textbox,
  fg = color.white,
})
...
local humidity_icon = wibox.widget({
  markup = '<span color="' .. color.magenta .. '" font="Ubuntu Nerd Font bold 16">' .. "󱪅 " .. "</span>",
  font = "Ubuntu Nerd Font 14",
  widget = wibox.widget.textbox,
  fg = color.white,
})
...
local wind_icon = wibox.widget({
  markup = '<span color="' .. color.green .. '" font="Ubuntu Nerd Font bold 16">' .. " " .. "</span>",
  font = "Ubuntu Nerd Font 14",
  widget = wibox.widget.textbox,
  fg = color.white,
})
...
local feels_like_icon = wibox.widget({
  markup = '<span color="' .. color.yellow .. '" font="Ubuntu Nerd Font bold 16">' .. "󱤋 " .. "</span>",
  font = "Ubuntu Nerd Font 14",
  widget = wibox.widget.textbox,
  fg = color.white,
})
...
awful.spawn.easy_async_with_shell(get_city, function(out)
  ...
  city_text.markup = '<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font 12">' .. str .. "</span>"
end)
