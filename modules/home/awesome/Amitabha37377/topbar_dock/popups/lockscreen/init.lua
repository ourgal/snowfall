...
local header_text = wibox.widget({
  markup = '<span color="' .. color.red .. '" font="Ubuntu Nerd Font Bold 30">' .. "SCREEN LOCKED!" .. "</span>",
...
local footer_text = wibox.widget({
  markup = '<span color="' .. color.blue .. '" font="Ubuntu Nerd Font Bold 22">' .. " Enter Password" .. "</span>",
  widget = wibox.widget.textbox,
  halign = "center",
  valign = "top",
})
...
local create_textbox = function(text, fg)
  local text_box = wibox.widget({
    markup = '<span color="' .. fg .. '" font="Ubuntu Nerd Font Bold 18">' .. text .. "</span>",
    halign = "left",
    valign = "center",
    widget = wibox.widget.textbox,
  })
...
---------------------------------
local clock =
  wibox.widget.textclock('<span color="' .. color.cyan .. '" font="Ubuntu Nerd Font Bold 75">%H:%M</span>', 10)

local date =
  wibox.widget.textclock('<span color="' .. color.blue .. '" font="Ubuntu Nerd Font Bold 35">%d %B, %A</span>', 10)
...
local incorrect_passwd = function()
  ...
  footer_text:set_markup_silently(
    '<span color="' .. color.red .. '" font="Ubuntu Nerd Font Bold 22">' .. " Wrong Password" .. "</span>"
  )
  text2.markup = '<span color="' .. color.green .. '" font="Ubuntu Nerd Font Bold 18">' .. "󰌆  " .. "</span>"
    ...
    keypressed_callback = function(mod, key, cmd)
      if #key == 1 then
        ...
        text2.markup = '<span color="'
          .. color.green
          .. '" font="Ubuntu Nerd Font Bold 18">'
          .. "󰌆  "
          .. "</span>"
          .. '<span color="'
          .. color.magenta
          .. '" font="Ubuntu Nerd Font Bold 14">'
          .. string.rep("", characters_entered)
          .. "</span>"
