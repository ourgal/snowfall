...
local close = wibox.widget({
  markup = '<span color="' .. "#df5b61" .. '" font="Ubuntu Nerd Font bold 23">' .. "  󰅙" .. "</span>",
  font = "Ubuntu Nerd Font Bold 14",
  widget = wibox.widget.textbox,
  fg = color.white,
})
...
close:connect_signal("mouse::enter", function()
  close:set_markup_silently(
    '<span color="' .. "#e36f84" .. '" font="Ubuntu Nerd Font bold 23">' .. "  󰅙" .. "</span>"
  )
end)

close:connect_signal("mouse::leave", function()
  close:set_markup_silently(
    '<span color="' .. "#df5b61" .. '" font="Ubuntu Nerd Font bold 23">' .. "  󰅙" .. "</span>"
  )
end)

close:connect_signal("button::press", function()
  close:set_markup_silently(
    '<span color="' .. color.red .. '" font="Ubuntu Nerd Font bold 23">' .. "  󰅙" .. "</span>"
  )
end)
