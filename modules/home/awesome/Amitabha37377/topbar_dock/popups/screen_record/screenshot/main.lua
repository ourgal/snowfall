...
local delay_text = wibox.widget({
  -- text = user.name,
  markup = '<span color="' .. color.white .. '" font="Ubuntu Nerd Font 15">' .. "Delay in seconds" .. "</span>",
...
local timer =
  wibox.widget({
    markup = '<span color="' .. color.blue .. '" font="Ubuntu Nerd Font bold 15">' .. "󱎫 " .. timer_value(
      delay_time
    ) .. " " .. "</span>",
    font = "Ubuntu Nerd Font Bold 14",
    widget = wibox.widget.textbox,
...
local increase_timer = wibox.widget({
  markup = '<span color="' .. color.yellow .. '" font="Ubuntu Nerd Font bold 15">' .. "    " .. "</span>",
  font = "Ubuntu Nerd Font Bold 14",
  widget = wibox.widget.textbox,
  fg = color.white,
})
...
increase_timer:connect_signal("button::press", function(_, _, _, button)
  if button == 1 then
    ...
    timer:set_markup_silently(
      '<span color="'
        .. color.blue
        .. '" font="Ubuntu Nerd Font bold 15">'
        .. "󱎫 "
        .. timer_value(delay_time)
        .. " "
        .. "</span>"
    )
  end
...
local decrease_timer = wibox.widget({
  markup = '<span color="' .. color.red .. '" font="Ubuntu Nerd Font bold 15">' .. "    " .. "</span>",
  font = "Ubuntu Nerd Font Bold 14",
  widget = wibox.widget.textbox,
  fg = color.white,
})
...
local pointer_text = wibox.widget({
  -- text = user.name,
  markup = '<span color="' .. color.white .. '" font="Ubuntu Nerd Font 15">' .. "Show mouse cursor" .. "</span>",
  font = "Ubuntu Nerd Font Bold 14",
  widget = wibox.widget.textbox,
  fg = color.white,
})
...
local toggle_button = wibox.widget({
  -- text = user.name,
  markup = '<span color="' .. color.blue .. '" font="Ubuntu Nerd Font bold 23">' .. "   " .. "</span>",
  font = "Ubuntu Nerd Font Bold 14",
  widget = wibox.widget.textbox,
  fg = color.white,
})
...
toggle_button:connect_signal("button::press", function(_, _, _, button)
  if button == 1 then
    ...
    if pointer_visible then
      toggle_button:set_markup_silently(
        '<span color="' .. color.blue .. '" font="Ubuntu Nerd Font bold 23">' .. "   " .. "</span>"
      )
    else
      toggle_button:set_markup_silently(
        '<span color="' .. color.blue .. '" font="Ubuntu Nerd Font bold 23">' .. "   " .. "</span>"
...
open_pictures:connect_signal("invoked", function()
