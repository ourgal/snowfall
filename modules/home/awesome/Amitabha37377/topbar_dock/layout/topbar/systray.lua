...
tray_toggle:connect_signal("button::press", function(_, _, _, button)
  if button == 1 then
    ...
    if systray.visible then
      widget:set_image(os.getenv("HOME") .. "/.config/awesome/layout/topbar/icons/arrow-right.png")
    else
      widget:set_image(os.getenv("HOME") .. "/.config/awesome/layout/topbar/icons/arrow-left.png")
    end
  end
end)
