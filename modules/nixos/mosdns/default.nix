...
let
  ...
  value = {
    environment = {
      ...
      etc = {
        "mosdns/config.yaml".text = builtins.toJSON {
          "api" = {
            "http" = "0.0.0.0:8338";
          };
          "include" = [
        ...
        "mosdns/dns.yaml".text = builtins.toJSON {
          "plugins" = [
            {
              "args" = {
                "concurrent" = 3;
        ...
        "mosdns/dat_exec.yaml".text = builtins.toJSON {
          "plugins" = [
            {
              "args" = {
                "files" = [
                  "${conf}/geoip_private.txt"
                ];
              };
              "tag" = "geoip_private";
              "type" = "ip_set";
            ...
            }
            {
              "args" = {
                "files" = [
                  "${conf}/geosite_geolocation-!cn.txt"
                ];
              };
            ...
            }
            {
              "args" = {
                "files" = [
                  "${conf}/geosite_category-ads-all.txt"
                ];
              };
              "tag" = "geosite_ads-all";
              "type" = "domain_set";
        ...
        "mosdns/rule/whitelist.txt".text = "";
        "mosdns/rule/greylist.txt".text = "";
      };
    };
